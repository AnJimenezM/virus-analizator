...
export const About = () => {
  ...
  <button className="carousel-control-next" type="button" data-bs-target="#carouselExampleInterval" data-bs-slide="next">
    ...
    <span className="visually-hidden">Next</span>
      ...
      <h2>Vision</h2>
      <p className='text-center mb-4 text-two'>Aplicacion web que se encarga de  detectar posibles vulnerabilidades de archivos dedicado  para todos los usuarios donde brinda buen funcionamiento  por el cual el sistema recibe las peticiones de los archivos y muestra los resultados.</p>
    </div>
  )
}
